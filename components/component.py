...
class Component(object):
    ...
    def add_component_controler(self, ctr_data):
        ...
        if 'add_joint' in ctr_data.keys():
            if ctr_data['add_joint'] in ['add', 'follow', 'parentConstraint']:
                ...
                raise Exception(
                    "When adding a controller joint, the only"
    ...
    def setup_driver(self):
        ...
        TODO: This needs to be splitted in 2 methods, one for the creation of
        the "main_driver", which should happen at the begginign of component
        creation and another one for constraining it to the target
        """
    ...
    def build_controls(self, graph_node, template=False):
        ...
        if 'add_joint' in data.keys():
            ...
            # Remove joint from data to avoid argument error
            del(data['add_joint'])
